...
The purpose of this task is to use information collected during the first 24 hours of an ICU stay to predict which patients survive their hospitalizations, and which patients do not.

To select a subset of explanatory variables our group of investigators will examine the SAPS1 score and the SOFA score included in the dataset in more detail to ascertain the variables that might be logically associated with increased mortality and poor survival. We will also assess the APACHE score which is commonly used in ICU risk prediction models.
...
***BELOW IS A LIST OF THE VARIABLES TO BE INCLUDED:***<br>
...
The purpose of this task is to understand the impact of information collected during the first 24 hours of an ICU stay on the survival times of the ICU population.
...
* In the exploratory analysis, we include variables that will increase SOFA, SAPS or APACHE scores (note that higher SOFA, SAPS and APACHE scores are associated with higher risk of mortality). 
        eg: increased BUN and reduced HCO3 will increase the SAPS score, therefore we will include BUN max (but not BUN_min and BUN_diff) and 
        HCO3_min (but not HCO3_max and HCO3_diff). Where both extremes of a variable will increase the risk score, both min and max variables will 
        be included.
...
* The median age is 67 with an interquartile (IQ) range of 26.
* The median height is 170.2 cm with IQ range of 15.2cm. There are 1069 (52%) with a valid measurements.
* The median maximum weight is 80kg with an IQ range of 28.55.
* The median Albumin_min score is 3.0 with an IQ range of 0.9.
* The median Albumin_min score is 3.0 with an IQ range of 0.9.
* The median Bilirubin_max score is 0.7 with an IQ range of 0.9.
* The median BUN_max score is 20 with an IQ range of 19.
* The median Creatinine_max score is 1.0 with an IQ range of 0.7.
* The median GCS_min score is 8 with an IQ range of 11.
* The median Glucose_min score is 117 with an IQ range of 43.The median Glucose_max score is 141 with an IQ range of 63.
* The median HCO3_min score is 23 with an IQ range of 5.
* The median HR_min score is 71 with an IQ range of 20. The median HR_max score is 104 with an IQ range of 28.
* The median K_min score is 3.9 with an IQ range of 0.8.The median K_max score is 4.3 with an IQ range of 0.7.
* The median Lactate_max score is 2.2 with an IQ range of 1.7.
* The median MAP_min score is 61 with an IQ range of 15.
* The median Na_min score is 138 with an IQ range of 5. The median Na_max score is 140 with an IQ range of 5.
* The median NISysABP_min score is 95 with an IQ range of 25. The median NISysABP_max score is 138 with an IQ range of 35.
* The median Platelets_min score is 184 with an IQ range of 120.
* The median PFratio_min score is 122 with an IQ range of 103.
* The median pH_min score is 7.34 with an IQ range of 0.11. The median pH_max score is 7.42 with an IQ range of 0.08.
* The median RespRate_min score is 14 with an IQ range of 5. The median Resprate_max score is 27 with an IQ range of 9.
* The median Temp_min score is 36.1 with an IQ range of 1.0. The median Temp_max score is 37.6 with an IQ range of 1.1.
* The median TroponinI_max score is 7.8 with an IQ range of 15.
* The median TroponinT_max score is 0.17 with an IQ range of 0.74.
* The median Urine_min score is 20 with an IQ range of 36.
* The median WBC_min score is 10.4 with an IQ range of 6.5. The median WBC_max score is 12.3 with an IQ range of 7.6.

****Meg/Haran: Is there any medical significance to the median clinical measures?? Otherwise, should we delete from commentary, since its just regurgitating what we can see in the code output.
...
```
**Selecting a Multivariable Cox models**
