...
The pertinent characteristics of our predictive model suggests that in the first 24 hours of an ICU admission, higher `Albumin_min` (OR: 0.26, 95% CI: 0.08-0.77, p = 0.02), `GCS_max` (OR: 0.83, 95% CI: 0.80-0.87, p < 0.001), `Na_min` (OR: 0.96, 95% CI: 0.94-0.99, p = 0.006), `Temp_min` (OR: 0.85, 95% CI: 0.73-0.99, p = 0.04), `Urine_min` (OR: 0.99, 95% CI: 0.99-1.00 p = 0.02) and `WBC_max` (OR: 0.93, 95% CI: 0.89-0.97, p = 0.002) values _reduce_ the odds of in-hospital death after an ICU admission of >48 hours, while higher `Bilirubin_max` (OR: 1.05, 95% CI: 1.02-1.08, p < 0.001), `BUN_max` (OR: 1.02, 95% CI: 1.01-1.02, p < 0.001), `HR_max` (OR: 1.01, 95% CI: 1.00-1.01, p = 0.02) and `WBC_min` (OR: 1.08, 95% CI: 1.03-1.14, p = 0.003) values _increase_ the odds of in-hospital death after an ICU admission of >48 hours.
...
* The estimated coefficients, related hazard rates (exponential of these coefficients) and the confidence interval of the hazard rates allow us to make some conclusions about clinical measures and their impact on ICU survival.
