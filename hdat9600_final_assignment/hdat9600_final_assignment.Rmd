...
***
Final paragraph
- summarising the most important findings of your final model & diagnostics. Include the most important values from the statistical output, and a simple clinical interpretation.
- ?explain why not poisson
- highlight that the aim is predictive (not explanatory), hence why some important values for understanding all risk factors not included
...
***
- explain what we see when fitting to df0
***
